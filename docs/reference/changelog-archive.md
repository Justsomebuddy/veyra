# Changelog Archive — Released Entries

Rotated verbatim out of the root `CHANGELOG.md` on 2026-08-27 to keep that
file inside the repository line-hygiene budget (newest first). The root
changelog carries `[Unreleased]` and any release newer than `[4.3.1]`.
