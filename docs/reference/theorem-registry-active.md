...
Typed de Bruijn syntax, substitution, independent inference, canonical graph replay, and byte/toolchain binding prove supported-checker soundness and `∀r:Recurrence, resonates r r`. This is not cyclic/phase resonance; see `docs/log/proof_carrying_core_r7.md`.
