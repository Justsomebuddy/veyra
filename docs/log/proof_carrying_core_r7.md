...
PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=. python3 -m pytest -q \
  tests/test_proof_core_*.py tests/proof/test_layer_derivations.py tests/kernel/test_axiom_kernel.py \
  tests/kernel/test_essence_core.py tests/sage/test_veyra_sage_essence.py
