...
This closes the narrow F5 blocker from `../concepts/foundational_gap_audit.md`: promoted Veyra artifacts have a ledger that names a classical statement, a Veyra artifact, and an honest verdict.
...
Implemented in `src/core/shadows/classical_benchmarks.py`.
