...
**Date:** 2026-08-04
**Primary API:** `src.core.observer.descent.core`
...
[the literature reduction](../concepts/r16_literature_reduction.md).

## Cross-links

- Derived path invariant: [doc 142](../concepts/crest_braid_derived_path_invariant_r16.md)
- Observer synthesis v2: [doc 140](../concepts/observer_synthesis_v2_r14.md)
- Native observer core: [doc 127](../concepts/native_observer_echo_core_r11.md)
- Definitions and theorems: [`../THEOREMS.md`](../../THEOREMS.md)
- Notation: [`../NOTATION.md`](../../NOTATION.md)
- Implementation: [`src/core/observer/descent.py`](../../src/core/observer/descent.py)
