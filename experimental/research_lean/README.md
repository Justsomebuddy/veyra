...
outside the 50-source stable Lean inventory and is not part of `make verify`.
...
the exact 50 stable and eight research sources into a temporary tree, compiles
