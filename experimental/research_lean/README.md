...
outside the 52-source stable Lean inventory and is not part of `make verify`.
...
the exact 52 stable and eight research sources into a temporary tree, compiles
