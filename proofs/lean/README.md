...
| `VeyraResonanceArithmetic.lean` | resonance arithmetic over the native `Recurrence`: the one-tact length observer as a bijective stitch/weave homomorphism onto `Nat`, weave laws, resonance = divisibility order, structural division with uniqueness, phase congruence characterization and laws, resonance primes = primes, Fermat and Euclid in the resonance vocabulary, strongest shared echo (gcd) and smallest shared closure (lcm); imports `VeyraNativeArithmetic`, `VeyraNecklaceOrbit` | `FORMALLY_PROVED` | `THM_RA_001_one_tact_shadow_bijective`, `THM_RA_002_stitch_shadow`, `THM_RA_003_weave_shadow`, `THM_RA_004_weave_laws`, `THM_RA_005_resonance_order`, `THM_RA_006_structural_division`, `THM_RA_007_phase_congruence_characterization`, `THM_RA_008_phase_congruence_laws`, `THM_RA_009_resonance_prime_iff`, `THM_RA_010_fermat_phase`, `THM_RA_011_escape_residual`, `THM_RA_012_euclid_escape`, `THM_RA_013_shared_echo`, `THM_RA_014_shared_closure` |
