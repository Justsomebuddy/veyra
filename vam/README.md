...
- Docs: `docs/003_reference_interpreter.md` through `docs/037_native_observer_synthesis_core.md` cover interpreter, VAM0/VAMD, optimizer, Core/HL-1 lowering, diagnostics/theorem carriers, native scaffold, v0.8/v0.9 contracts, v1.x/v2.x finite semantics/metadata, and the bounded Rust synthesis shadow.
