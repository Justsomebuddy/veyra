...
from .bridge import check_lean_echo_export
...
from ..paths import LEAN_DIR, TMP_DIR
...
def lean_cyclic_period_export_path() -> Path:
    ...
    result = LEAN_DIR / "VeyraCyclic.lean"
...
def lean_pythagorean_export_path() -> Path:
    ...
    result = LEAN_DIR / "VeyraGeometry.lean"
...
def lean_algebra_export_path() -> Path:
    ...
    result = LEAN_DIR / "VeyraAlgebra.lean"
...
def lean_probability_export_path() -> Path:
    ...
    result = LEAN_DIR / "VeyraProbability.lean"
...
def lean_statistics_export_path() -> Path:
    ...
    result = LEAN_DIR / "VeyraStatistics.lean"
...
def lean_combinatorics_export_path() -> Path:
    ...
    result = LEAN_DIR / "VeyraCombinatorics.lean"
