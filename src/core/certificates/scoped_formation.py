...
from .translated_confluence import _fixture as c3_fixture
...
from ..confluence.types import AlignmentPoint
from ..construction.finite_builder.types import PulseStep, SeedRef
from ..construction.finite_construction import (
    construction_source_binding, finite_builder_program, finite_recurrence_seed,
)
from ..observer.patch_atlas import observer_patch, observer_patch_atlas
...
from ..construction.scoped_formation.runtime import scoped_formation_judgment
from ..construction.scoped_formation.result_validation import validate_scoped_formation_result
from ..construction.scoped_formation.refinement import formation_refinement_requirement
from ..construction.scoped_formation.scope import formation_scope
from ..construction.scoped_formation.sources import (
...
from ..construction.scoped_formation.types import (
    RequiredConfluenceLevel, ScopedFormationJudgment,
    ScopedFormationResourceLimit, ScopedFormationStatus, SurvivalMode,
)
from ..confluence.translated.core import translated_confluence_policy
