...
def test_completion_files_remain_modular():
    paths = (
        PROJECT_ROOT / "vam/src/optimizer_completion.py",
        PROJECT_ROOT / "vam/src/quantified_theorem.py",
        PROJECT_ROOT / "vam/native/src/quantified_theorem.rs",
        PROJECT_ROOT / "tests/vam/test_vam_optimizer_completion.py",
        PROJECT_ROOT / "tests/vam/test_vam_quantified_theorem.py",
    )
