...
def installed_import_smoke(wheel: Path, scratch: Path, label: str) -> None:
    ...
    script = "\n".join(
        (
            ...
            "for module in (src.core, src.core.claim_composition, src.core.observer_discovery_v3.ingestion, src.core.observer_provenance, src.core.p1a_realization_transport_v2, src.core.realization_transport, veyra_sage.all, vam.src):",
